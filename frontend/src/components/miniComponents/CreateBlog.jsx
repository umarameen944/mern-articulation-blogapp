      ...
      <div className="container">
        <form onSubmit={handleBlog}>
          ...
          <div className="sub-para">
            ...
            <textarea
              rows="10"
              placeholder="Article First Sub Paragraph Comes Here..."
          ...
          <div className="sub-para">
            ...
            <textarea
              rows="10"
              placeholder="Article Second Sub Paragraph Comes Here..."
          ...
          <div className="sub-para">
            ...
            <textarea
              rows="10"
              placeholder="Article Third Sub Paragraph Comes Here..."
